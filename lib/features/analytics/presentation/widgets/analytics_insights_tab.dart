...
import 'package:rejabon_ai/shared/widgets/insight_card.dart';

import '../../domain/analytics_insight_service.dart';

/// Analitika hub — insightlar tabi.
class AnalyticsInsightsTab extends ConsumerWidget {
  const AnalyticsInsightsTab({super.key});
