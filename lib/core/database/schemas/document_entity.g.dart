...
void _documentEntitySerialize(
  ...
  writer.writeStringList(offsets[3], object.lifeAreaIds);
...
DocumentEntity _documentEntityDeserialize(
  ...
  object.lifeAreaIds = reader.readStringList(offsets[3]) ?? [];
...
extension DocumentEntityQueryWhereSort
  ...
  QueryBuilder<DocumentEntity, DocumentEntity, QAfterWhere> anyCreatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension DocumentEntityQueryWhere
  ...
  QueryBuilder<DocumentEntity, DocumentEntity, QAfterWhereClause> titleEqualTo(
      String title) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DocumentEntity, DocumentEntity, QAfterWhereClause> typeEqualTo(
      String type) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'type',
...
extension DocumentEntityQuerySortBy
  ...
  QueryBuilder<DocumentEntity, DocumentEntity, QAfterSortBy> sortByMediaType() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DocumentEntity, DocumentEntity, QAfterSortBy> sortBySourceUrl() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DocumentEntity, DocumentEntity, QAfterSortBy> sortByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<DocumentEntity, DocumentEntity, QAfterSortBy> sortByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension DocumentEntityQuerySortThenBy
  ...
  QueryBuilder<DocumentEntity, DocumentEntity, QAfterSortBy> thenByMediaType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'mediaType', Sort.asc);
    });
  }
  ...
  QueryBuilder<DocumentEntity, DocumentEntity, QAfterSortBy> thenBySourceUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sourceUrl', Sort.asc);
    });
  }
  ...
  QueryBuilder<DocumentEntity, DocumentEntity, QAfterSortBy> thenByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<DocumentEntity, DocumentEntity, QAfterSortBy> thenByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.desc);
    });
  }
...
extension DocumentEntityQueryWhereDistinct
  ...
  QueryBuilder<DocumentEntity, DocumentEntity, QDistinct>
      distinctByLifeAreaIds() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'lifeAreaIds');
    });
  }

  QueryBuilder<DocumentEntity, DocumentEntity, QDistinct> distinctByMediaType(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DocumentEntity, DocumentEntity, QDistinct> distinctBySourceUrl(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DocumentEntity, DocumentEntity, QDistinct> distinctByType(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension DocumentEntityQueryProperty
  ...
  QueryBuilder<DocumentEntity, bool, QQueryOperations> isFavoriteProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DocumentEntity, String, QQueryOperations> mediaTypeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'mediaType');
    });
  }

  QueryBuilder<DocumentEntity, String?, QQueryOperations> sourceUrlProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DocumentEntity, String, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
